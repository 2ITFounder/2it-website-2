...
export const metadata: Metadata = {
  ...
  description: "Informativa sulla privacy e sul trattamento dei dati personali di Nexus Agency.",
}
        ...
        <Section>
          <Container size="sm">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Il titolare del trattamento dei dati personali è Nexus Agency S.r.l., con sede legale in Via Roma 123,
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                possibile contattarci all'indirizzo: privacy@nexusagency.it
              </p>
            </div>
          </Container>
        </Section>
