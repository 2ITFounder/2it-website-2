    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        >
          <div
            className={cn(
              "inline-flex items-center gap-2 px-6 py-3 rounded-full glass mb-8",
              "transition-all duration-700 delay-200 animate-pulse-glow",
          ...
          <h1
            className={cn(
              "text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight text-balance",
          ...
          <p
            className={cn(
              "mt-8 text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed text-pretty",
          ...
          >
            <Button
              ...
              className={cn(
                ...
                "hover:shadow-2xl hover:scale-105 transition-all duration-500 active:scale-95",
              )}
              asChild
            >
              <Link href="/contatti">
            ...
            <Button
              ...
              variant="outline"
              className={cn(
                "text-lg px-10 py-6 glass border-2 border-primary/30 group",
          ...
          <div
            className={cn(
              "mt-20 grid grid-cols-3 gap-12 max-w-2xl mx-auto",
            ...
            {[
              ...
              <div
                ...
                className={cn(
                  ...
                  "transition-all duration-500 hover:scale-110 animate-bounce-in",
                )}
